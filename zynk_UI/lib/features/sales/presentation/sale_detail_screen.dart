...
class SaleDetailScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    bool hasOwnerApproval = approvals.any(
      (a) =>
          a.approverRole?.toLowerCase() == 'owner' &&
          a.decision == SaleApprovalDecision.approved,
    );
    bool hasStaffApproval = approvals.any(
      (a) =>
          a.approverRole?.toLowerCase() != 'owner' &&
          a.decision == SaleApprovalDecision.approved,
    );
    bool hasCurrentUserApproved = approvals.any(
      (a) =>
          a.approverUserId == currentUserId &&
          a.decision == SaleApprovalDecision.approved,
    );
    ...
    if (saleAsync.value != null &&
        saleAsync.value!.approvalCount >= saleAsync.value!.requiredApprovals) {
